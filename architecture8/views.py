...
DB_HOST_READ="<YOUR_READ_RDS_ENDPOINT>"
DB_HOST_WRITE="<YOUR_WRITE_RDS_ENDPOINT>"
DB_USER="root"
...
def index():
    ...
    connection = pymysql.connect(host=DB_HOST_READ,
                             user=DB_USER,
...
def signup():
    ...
    connection = pymysql.connect(host=DB_HOST_WRITE,
                             user=DB_USER,
                             password=DB_PASSWORD,
                             db=DB_NAME,
                             charset='utf8',
